...
logging.basicConfig(filename='augmentation.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
output_folder = r'deleted-image-ratio0.4_3'
ratio = 0.4  # Adjust this ratio to the desired class 0 to class 1 ratio
...
augment_images_and_labels(image_folder, output_folder, 'augmented_output_1', target_class=1, original_class_1_count=original_class_1_count)
